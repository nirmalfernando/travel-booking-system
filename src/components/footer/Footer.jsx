  ...
  return (
    <div className="footer">
        <div className="fLists">
            <ul className="fList">Company
                <li className="fListItem">About Us</li>
                <li className="fListItem">Privacy Policy</li>
                <li className="fListItem">Terms & Conditions</li>
            </ul>
            <ul className="fList">Destinations
            ...
            <ul className="fList">Social Media
        ...
        <div className="fText">
            Copyright <span><FontAwesomeIcon icon={faCopyright} /></span> 2023 by NIBM DSE22.2F <br/>
            All Rights Reserved by Nirmal Fernando, Shaliha Shifry, Isuru Theekshana, Malith Kumaranayake.
        </div>
    </div>
  )
}
